...
import { PcSideNav } from "@/app/globalComponents/pcSideNav";
import { MobileNav } from "@/app/globalComponents/mobileNav";
...
export const ApplicationForm = () => {
    ...
    return ( 
        <main className="bg-white dark:bg-dark_1 h-screen">
          ...
          <AppForm firstname={std.firstname} lastname={std.lastname} stdid={student.stdid} email={std.email}/>
      </div>
               <MobileNav />
