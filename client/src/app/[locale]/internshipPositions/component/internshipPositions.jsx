          ...
          >
            ...
            {card.slice(0, 6).map((cards, index) => (
              <div
                key={index}
                className={
                  "text-xs sm:text-sm md:text-md lg:text-lg bg-white dark:bg-background_shade_2 w-[22rem] mx-1.5 my-1 rounded h-fit"
                }
              >
                ...
                <div className={"flex justify-end px-2 pb-3 items-center"}>
                  <div
                    className={
                      "bg-yellow p-1 gap-2 rounded inline-flex items-center"
                    }
                  >
                    <FaRegClock />
