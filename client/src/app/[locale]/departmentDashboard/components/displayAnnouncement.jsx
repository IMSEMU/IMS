          ...
          {announcements.length === 0 ? (
            ...
            announcements.map((announcement, index) => (
              <div
                ...
                className="min-w-full  cursor-pointer mx-1 py-1 md:py-1.5 lg:py-2 my-1 bg-white drop-shadow-md border-background_shade_2  hover:border-l-8 hover:border-l-yellow duration-300 border text-black dark:bg-dark_4 dark:text-black flex gap-2 items-center justify-between rounded"
                onClick={() => {
                  EditAnnouncement(announcement)
                }}
              >
                <div className="ml-2  flex flex-wrap gap-1 w-fit">
                  <div className="p-1.5 md:p-2.5 lg:p-3 bg-dark_2 text-yellow text-xl rounded">
                    <BsMegaphoneFill />
                  </div>
                </div>

                <div
                  className={"truncate text-sm lg:text-md justify-start items-start gap-1 md:gap-3"}
                >
                  <p className={"font-semibold capitalize "}>
                    {announcement.title}
                  </p>
                  <span className={"truncate text-xs md:text-sm lg:text-md"}>
                ...
                >
                  ...
                  {/* options */}
                  {hideOptions[index] && (
                    <div className="from-left absolute text-black -right-2 -top-[1.1rem] h-fit border border-background_shade_2 rounded w-[5rem] bg-white dark:bg-dark_2 dark:text-white dark:border-dark_2">
                      <div className="relative">
                        ...
                        <span
                          className="absolute p-[0.1rem] cursor-pointer text-lg top-[1rem] bg-white dark:bg-dark_2 rounded -left-6"
                          onClick={() => {
                            closeOptions();
                          }}
                        >
          ...
          <div className="flex flex-col justify-center items-center">
            <div>
              ...
              {/* <div className={"w-full mb-3"}>
                <p
                  className={
                    " font-bold m-3 truncate text-black dark:text-white text-sm md:text-md lg:text-lg  inline-flex text-center  border-yellow border-x-[0.4rem] md:border-x-[0.3rem] px-2"
                  }
                >
