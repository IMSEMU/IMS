...
export const DisplayInternshipPositions = ({
  ...
  return (
    <main onClick={closeOptions}>
            ...
            internships.map((internship, index) => (
              ...
              >
                ...
                <div className="flex flex-wrap justify-center text-center items-center gap-0 rounded w-full truncate">
                  ...
                  <p className="rounded truncate text-sm w-[70%]">
                    {internship.position}
                  </p>
                </div>
      ...
      {positionToShow && (
        <Modal onClose={() => setPositionToShow(null)}>
              ...
              <div className="flex gap-3 justify-center py-2 items-center">
                <div className="flex flex-wrap gap-3 justify-center items-center">
                  <div className="w-[90%] justify-center text-center">
                    {positionToShow.photo && (
                      <Image
                        src={positionToShow.photo}
                        width={1000}
                        height={1000}
                        alt=""
                  ...
                  <div className="w-[90%]">
                    <p className="rounded p-3 outline-none w-full border border-dark_4 dark:border-none dark:bg-background_shade_2 text-dark_2">
                      {positionToShow.compname}
                    </p>
                  </div>
                  <div className="w-[90%]">
                    <p className="rounded p-3 outline-none w-full border border-dark_4 dark:border-none dark:bg-background_shade_2 text-dark_2">
                  ...
                  <div className="w-[90%]">
                    <p className="rounded p-3 outline-none w-full border border-dark_4 dark:border-none dark:bg-background_shade_2 text-dark_2">
                      {positionToShow.requirements}
                    </p>
                  </div>
                  <div className="relative w-[44%]">
                    <p className="rounded p-3 outline-none w-full border border-dark_4 dark:border-none dark:bg-background_shade_2 text-dark_2">
                      {positionToShow.applyby.split("T")[0]}
                    </p>
                  </div>
                  <div className="relative w-[44%]">
                    <p className="rounded p-3 outline-none w-full border border-dark_4 dark:border-none dark:bg-background_shade_2 text-dark_2">
                      {positionToShow.contact}
                    </p>
                  </div>
                </div>
              </div>
