...
export const ConForm = () => {
  ...
  return (
    <main className="h-full pb-10">
      <div className="my-1 flex justify-center items-center dark:bg-dark_3 font-bold py-5">
        <div className="invisible absolute">
          <PrintConfirmation formData={formData} ref={componentRef} />
        </div>
        <div className="border-x-[0.4rem] text-md lg:text-2xl border-yellow dark:text-white">
          <p className="px-2">{t("title")}</p>
        </div>
      </div>
      <div className=" h-full">
      <section className="p-2  bg-white dark:bg-dark_3 h-[10%] flex items-center justify-center px-4 sm:px-12 md:px-20">
        {form ? (
          <div className="bg-white h-fit dark:bg-dark_2 p-3.5 flex rounded shadow-xl dark:border-none border border-background_shade_2 w-[40rem] lg:w-[50rem]  pb-10">
            <div className=" w-full  text-black dark:text-white  ">
              <p
                className={
                  " font-bold my-4 text-black dark:text-white text-md lg:text-lg  inline-flex text-center  border-yellow border-x-[0.3rem] md:border-x-[0.3rem] px-2"
                }
              >
                {t("sTitle")}
              </p>

              <form className="text-sm md:text-md">
        ...
        <Modal onClose={() => setHasValidationError(false)}>
          <div className="flex flex-col  justify-center items-center">
            ...
            <button
              ...
              className="bg-blue rounded text-white px-3 py-1 mt-2"
            >
              Close
            </button>
          </div>
