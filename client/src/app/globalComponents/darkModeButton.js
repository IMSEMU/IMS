...
export const DarkModeButton = () => {
  ...
  return (
    <button className={'mx-3 p-0.5 gap-2 rounded flex text-sm md:text-md  bg-background_shade_2 dark:bg-dark_1 outline-0'} onClick={() => setDarkMode(prevMode => !prevMode)}>
